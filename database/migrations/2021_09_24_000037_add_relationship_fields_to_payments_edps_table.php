...
class AddRelationshipFieldsToPaymentsEdpsTable extends Migration
{
    public function up()
    {
        Schema::table('payments_edps', function (Blueprint $table) {
            ...
            $table->foreign('admission_no_id', 'admission_no_fk_4947859')->references('id')->on('admissions_edps');
            $table->unsignedBigInteger('payment_source_id');
            $table->foreign('payment_source_id', 'payment_source_fk_4947851')->references('id')->on('payment_sources');
        });
    }
}
