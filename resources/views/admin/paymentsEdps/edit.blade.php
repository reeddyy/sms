            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('admission_no') ? 'is-invalid' : '' }}" name="admission_no_id" id="admission_no_id" required>
                    @foreach($admission_nos as $admission_no)
                        <option value="{{ $admission_no->id }}" {{ (old('admission_no_id') ? old('admission_no_id') : $paymentsEdp->admission_no->id ?? '') == $admission_no->id ? 'selected' : '' }}>{{ $admission_no->admission_no }} | {{ $admission_no->participant_name->name }}</option>
                    @endforeach
                </select>
