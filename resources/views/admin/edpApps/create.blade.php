    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.edp-apps.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_4') ? 'is-invalid' : '' }}" type="text" name="duration_4" id="duration_4" value="{{ old('duration_4', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_5') ? 'is-invalid' : '' }}" type="text" name="duration_5" id="duration_5" value="{{ old('duration_5', '') }}">
