    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.edp-apps.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input readonly class="form-control {{ $errors->has('application_no') ? 'is-invalid' : '' }}" type="text" name="application_no" id="application_no" value="{{ old('application_no', App\Helpers\ApplicationNoHelper::getAppNo('EdpApp')) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_1') ? 'is-invalid' : '' }}" type="number" name="duration_1" id="duration_1" value="{{ old('duration_1', '') }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_2') ? 'is-invalid' : '' }}" type="number" name="duration_2" id="duration_2" value="{{ old('duration_2', '') }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_3') ? 'is-invalid' : '' }}" type="number" name="duration_3" id="duration_3" value="{{ old('duration_3', '') }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_4') ? 'is-invalid' : '' }}" type="number" name="duration_4" id="duration_4" value="{{ old('duration_4', '') }}" step="0.1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_5') ? 'is-invalid' : '' }}" type="number" name="duration_5" id="duration_5" value="{{ old('duration_5', '') }}" step="0.1">
