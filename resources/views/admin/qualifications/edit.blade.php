    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qualifications.update", [$qualification->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('instalment_amount') ? 'is-invalid' : '' }}" type="number" name="instalment_amount" id="instalment_amount" value="{{ old('instalment_amount', $qualification->instalment_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('module_name') ? 'is-invalid' : '' }}" name="module_name_id" id="module_name_id">
                    @foreach($module_names as $id => $entry)
                        <option value="{{ $id }}" {{ (old('module_name_id') ? old('module_name_id') : $qualification->module_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('module_grade') ? 'is-invalid' : '' }}" name="module_grade_id" id="module_grade_id">
                    @foreach($module_grades as $id => $entry)
                        <option value="{{ $id }}" {{ (old('module_grade_id') ? old('module_grade_id') : $qualification->module_grade->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
