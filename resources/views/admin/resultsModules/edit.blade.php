...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.results-modules.update", [$resultsModule->id]) }}"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label class="required"
                            for="enrolment_no_id">{{ trans('cruds.resultsModule.fields.enrolment_no') }}</label>
                        <select class="form-control select2 {{ $errors->has('enrolment_no') ? 'is-invalid' : '' }}"
                            name="enrolment_no_id" id="enrolment_no_id" required>
                            @foreach($enrolment_nos->unique('enrolment_no') as $enrolment_no)
                            <option value="{{ $enrolment_no->id }}"
                                {{ (old('enrolment_no_id') ? old('enrolment_no_id') : $resultsModule->enrolment_no->id ?? '') == $enrolment_no->id ? 'selected' : '' }}>
                                {{ $enrolment_no->enrolment_no }} | {{ $enrolment_no->student_name->name }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input class="form-control date {{ $errors->has('date_release') ? 'is-invalid' : '' }}" type="text"
                            name="date_release" id="date_release"
                            value="{{ old('date_release', $resultsModule->date_release) }}">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_1') ? 'is-invalid' : '' }}"
                            name="module_1_id" id="module_1_id">
                            @foreach($module_1s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_1_id') ? old('module_1_id') : $resultsModule->module_1->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_1') ? 'is-invalid' : '' }}" name="grade_1_id"
                            id="grade_1_id">
                            @foreach($grade_1s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_1_id') ? old('grade_1_id') : $resultsModule->grade_1->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_2') ? 'is-invalid' : '' }}"
                            name="module_2_id" id="module_2_id">
                            @foreach($module_2s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_2_id') ? old('module_2_id') : $resultsModule->module_2->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_2') ? 'is-invalid' : '' }}" name="grade_2_id"
                            id="grade_2_id">
                            @foreach($grade_2s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_2_id') ? old('grade_2_id') : $resultsModule->grade_2->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_3') ? 'is-invalid' : '' }}"
                            name="module_3_id" id="module_3_id">
                            @foreach($module_3s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_3_id') ? old('module_3_id') : $resultsModule->module_3->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_3') ? 'is-invalid' : '' }}" name="grade_3_id"
                            id="grade_3_id">
                            @foreach($grade_3s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_3_id') ? old('grade_3_id') : $resultsModule->grade_3->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_4') ? 'is-invalid' : '' }}"
                            name="module_4_id" id="module_4_id">
                            @foreach($module_4s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_4_id') ? old('module_4_id') : $resultsModule->module_4->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_4') ? 'is-invalid' : '' }}" name="grade_4_id"
                            id="grade_4_id">
                            @foreach($grade_4s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_4_id') ? old('grade_4_id') : $resultsModule->grade_4->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_5') ? 'is-invalid' : '' }}"
                            name="module_5_id" id="module_5_id">
                            @foreach($module_5s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_5_id') ? old('module_5_id') : $resultsModule->module_5->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_5') ? 'is-invalid' : '' }}" name="grade_5_id"
                            id="grade_5_id">
                            @foreach($grade_5s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_5_id') ? old('grade_5_id') : $resultsModule->grade_5->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('module_6') ? 'is-invalid' : '' }}"
                            name="module_6_id" id="module_6_id">
                            @foreach($module_6s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('module_6_id') ? old('module_6_id') : $resultsModule->module_6->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select onchange="calculateTotalPoints();"
                            class="form-control select2 {{ $errors->has('grade_6') ? 'is-invalid' : '' }}" name="grade_6_id"
                            id="grade_6_id">
                            @foreach($grade_6s as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('grade_6_id') ? old('grade_6_id') : $resultsModule->grade_6->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input disabled class="form-control {{ $errors->has('total_result_points') ? 'is-invalid' : '' }}"
                            type="number" id="total_result_points"
                            value="{{ old('total_result_points', $resultsModule->total_result_points) }}" step="1">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control select2 {{ $errors->has('achievement_title') ? 'is-invalid' : '' }}"
                            name="achievement_title_id" id="achievement_title_id">
                            @foreach($achievement_titles as $id => $entry)
                            <option value="{{ $id }}"
                                {{ (old('achievement_title_id') ? old('achievement_title_id') : $resultsModule->achievement_title->id ?? '') == $id ? 'selected' : '' }}>
                                {{ $entry }}</option>
                            @endforeach
                        </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label
                            for="date_transcript_sent_1">{{ trans('cruds.resultsModule.fields.date_transcript_sent_1') }}</label>
                        <input class="form-control date {{ $errors->has('date_transcript_sent_1') ? 'is-invalid' : '' }}"
                            type="text" name="date_transcript_sent_1" id="date_transcript_sent_1"
                            value="{{ old('date_transcript_sent_1', $resultsModule->date_transcript_sent_1) }}">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label
                            for="date_transcript_sent_2">{{ trans('cruds.resultsModule.fields.date_transcript_sent_2') }}</label>
                        <input class="form-control date {{ $errors->has('date_transcript_sent_2') ? 'is-invalid' : '' }}"
                            type="text" name="date_transcript_sent_2" id="date_transcript_sent_2"
                            value="{{ old('date_transcript_sent_2', $resultsModule->date_transcript_sent_2) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note"
                    id="note">{{ old('note', $resultsModule->note) }}</textarea>
                @if($errors->has('note'))
                <div class="invalid-feedback">
                    {{ $errors->first('note') }}
                </div>
...
function calculateTotalPoints() {
    ...
    var total_points = parseInt(grade1_point) + parseInt(grade2_point) + parseInt(grade3_point) + parseInt(
        grade4_point) + parseInt(grade5_point) + parseInt(grade6_point);
