                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input onkeyup="updateOutstanding()" class="form-control {{ $errors->has('total_fees') ? 'is-invalid' : '' }}" type="number" name="total_fees" id="total_fees" value="{{ old('total_fees', $admissionsEdp->total_fees) }}" step="0.01">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control {{ $errors->has('amount_paid') ? 'is-invalid' : '' }}" type="number" name="amount_paid" id="amount_paid" value="{{ old('amount_paid', $admissionsEdp->amount_paid) }}" step="0.01">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <input readonly class="form-control {{ $errors->has('outstanding_balance') ? 'is-invalid' : '' }}" type="number" name="outstanding_balance" id="outstanding_balance" value="{{ old('outstanding_balance', $admissionsEdp->outstanding_balance) }}" step="0.01">
...
<script>
    $(document).ready(function(){
        var id = {!! $admissionsEdp->application_no->id !!};
        runAjax(id);
    })
