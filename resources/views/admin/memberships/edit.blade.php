    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.memberships.update", [$membership->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('member_name') ? 'is-invalid' : '' }}" name="member_name_id" id="member_name_id" required>
                    @foreach($member_names as $id => $entry)
                        <option value="{{ $id }}" {{ (old('member_name_id') ? old('member_name_id') : $membership->member_name->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Membership::MEMBER_CLASS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('member_class') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="member_class_{{ $key }}" name="member_class" value="{{ $key }}" {{ old('member_class', $membership->member_class) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('membership_start_date') ? 'is-invalid' : '' }}" type="text" name="membership_start_date" id="membership_start_date" value="{{ old('membership_start_date', $membership->membership_start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('membership_expiry_date') ? 'is-invalid' : '' }}" type="text" name="membership_expiry_date" id="membership_expiry_date" value="{{ old('membership_expiry_date', $membership->membership_expiry_date) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Membership::MEMBERSHIP_VALIDITY_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('membership_validity') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="membership_validity_{{ $key }}" name="membership_validity" value="{{ $key }}" {{ old('membership_validity', $membership->membership_validity) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_of_renewal') ? 'is-invalid' : '' }}" type="number" name="no_of_renewal" id="no_of_renewal" value="{{ old('no_of_renewal', $membership->no_of_renewal) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_amount') ? 'is-invalid' : '' }}" type="number" name="payment_amount" id="payment_amount" value="{{ old('payment_amount', $membership->payment_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('payment_date') ? 'is-invalid' : '' }}" type="text" name="payment_date" id="payment_date" value="{{ old('payment_date', $membership->payment_date) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_receipt_no') ? 'is-invalid' : '' }}" type="text" name="payment_receipt_no" id="payment_receipt_no" value="{{ old('payment_receipt_no', $membership->payment_receipt_no) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('payment_note') ? 'is-invalid' : '' }}" type="text" name="payment_note" id="payment_note" value="{{ old('payment_note', $membership->payment_note) }}">
