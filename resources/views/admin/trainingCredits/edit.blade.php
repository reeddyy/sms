...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.trainingCredit.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.training-credits.update", [$trainingCredit->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('membership_no') ? 'is-invalid' : '' }}" name="membership_no_id" id="membership_no_id" required>
                    @foreach($membership_nos as $id => $entry)
                        <option value="{{ $id }}" {{ (old('membership_no_id') ? old('membership_no_id') : $trainingCredit->membership_no->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tc_brought_forward') ? 'is-invalid' : '' }}" type="number" name="tc_brought_forward" id="tc_brought_forward" value="{{ old('tc_brought_forward', $trainingCredit->tc_brought_forward) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_credit') ? 'is-invalid' : '' }}" type="number" name="training_credit" id="training_credit" value="{{ old('training_credit', $trainingCredit->training_credit) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('digital_resisilience_fund') ? 'is-invalid' : '' }}" type="number" name="digital_resisilience_fund" id="digital_resisilience_fund" value="{{ old('digital_resisilience_fund', $trainingCredit->digital_resisilience_fund) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('digital_enabler_fund') ? 'is-invalid' : '' }}" type="number" name="digital_enabler_fund" id="digital_enabler_fund" value="{{ old('digital_enabler_fund', $trainingCredit->digital_enabler_fund) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cf_used') ? 'is-invalid' : '' }}" type="number" name="cf_used" id="cf_used" value="{{ old('cf_used', $trainingCredit->cf_used) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cf_avaliable') ? 'is-invalid' : '' }}" type="number" name="cf_avaliable" id="cf_avaliable" value="{{ old('cf_avaliable', $trainingCredit->cf_avaliable) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('valid_till') ? 'is-invalid' : '' }}" type="text" name="valid_till" id="valid_till" value="{{ old('valid_till', $trainingCredit->valid_till) }}">
