    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.qualifications-apps.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input readonly class="form-control {{ $errors->has('application_no') ? 'is-invalid' : '' }}" type="text" name="application_no" id="application_no" value="{{ old('application_no', App\Helpers\ApplicationNoHelper::getAppNo('QualificationsApp')) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('officer_email') ? 'is-invalid' : '' }}" type="text" name="officer_email" id="officer_email" value="{{ old('officer_email', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_1') ? 'is-invalid' : '' }}" type="text" name="duration_1" id="duration_1" value="{{ old('duration_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_2') ? 'is-invalid' : '' }}" type="text" name="duration_2" id="duration_2" value="{{ old('duration_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration_3') ? 'is-invalid' : '' }}" type="text" name="duration_3" id="duration_3" value="{{ old('duration_3', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_attained_1') ? 'is-invalid' : '' }}" type="text" name="year_attained_1" id="year_attained_1" value="{{ old('year_attained_1', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('year_attained_2') ? 'is-invalid' : '' }}" type="text" name="year_attained_2" id="year_attained_2" value="{{ old('year_attained_2', '') }}">
