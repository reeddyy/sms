...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-intakesModules">
                <thead>
                    <tr>
                        <th width="10">
                        ...
                        <th>
                            {{ trans('cruds.module.fields.intakes') }}
                        </th>
                        <th>
                ...
                <tbody>
                    @foreach($modules as $key => $module)
                        <tr data-entry-id="{{ $module->id }}">
                            ...
                            <td>
                                @foreach($module->intakes as $key => $item)
                                    <span class="badge badge-info">{{ $item->intake_code }}</span>
                                @endforeach
                            </td>
                            <td>
...
@endcan
  ...
  let table = $('.datatable-intakesModules:not(.ajaxTable)').DataTable({ buttons: dtButtons })
