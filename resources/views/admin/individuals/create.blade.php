    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.individuals.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input onkeyup="updateRelevantExp()" class="form-control {{ $errors->has('duration_of_year_s_1') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_1" id="duration_of_year_s_1" value="{{ old('duration_of_year_s_1', '') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input onkeyup="updateRelevantExp()" class="form-control {{ $errors->has('duration_of_year_s_2') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_2" id="duration_of_year_s_2" value="{{ old('duration_of_year_s_2', '') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input onkeyup="updateRelevantExp()" class="form-control {{ $errors->has('duration_of_year_s_3') ? 'is-invalid' : '' }}" type="number" name="duration_of_year_s_3" id="duration_of_year_s_3" value="{{ old('duration_of_year_s_3', '') }}" step="0.001">
            ...
            <div class="form-group">
                ...
                <input readonly="true" class="form-control {{ $errors->has('total_year_s_related_work_exp') ? 'is-invalid' : '' }}" type="number" name="total_year_s_related_work_exp" id="total_year_s_related_work_exp" value="{{ old('total_year_s_related_work_exp', '') }}" step="0.001">
