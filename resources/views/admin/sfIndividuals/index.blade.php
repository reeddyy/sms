...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-SfIndividual">
                <thead>
                    <tr>
                        <th width="10">
                    ...
                    <tr>
                        ...
                        <td>
                            <select class="search">
                                <option value>{{ trans('global.all') }}</option>
                                @foreach($cf_purposes as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-SfIndividual:not(.ajaxTable)').DataTable({ buttons: dtButtons })
