    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.individuals-apps.update", [$individualsApp->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input readonly class="form-control {{ $errors->has('application_no') ? 'is-invalid' : '' }}" type="text" name="application_no" id="application_no" value="{{ old('application_no', $individualsApp->application_no) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('duration') ? 'is-invalid' : '' }}" type="number" name="duration" id="duration" value="{{ old('duration', $individualsApp->duration) }}" step="0.1">
