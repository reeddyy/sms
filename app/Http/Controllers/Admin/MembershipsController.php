...
class MembershipsController extends Controller
{
    public function index()
    {
        ...
        $memberships = Membership::with(['member_name'])->get();
    ...
    public function create()
    {
        ...
        return view('admin.memberships.create', compact('member_names'));
    }
    ...
    public function edit(Membership $membership)
    {
        ...
        $membership->load('member_name');

        return view('admin.memberships.edit', compact('member_names', 'membership'));
    }
